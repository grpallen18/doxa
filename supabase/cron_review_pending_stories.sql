...
-- Re-reviews PENDING stories that have full body content (first 3000 chars to LLM). Every 2 minutes.
--
-- Prerequisites:
...
--
-- To remove later: select cron.unschedule('review-pending-stories-every-2min');

select cron.schedule(
  'review-pending-stories-every-2min',
  '*/2 * * * *',
  $$
