-- Replace claim_relationships_24h with position_relationships_24h for New Position Pairs.
-- claim_relationships (claim pairs) is obsolete; position_relationships (position pairs) is the new architecture.
