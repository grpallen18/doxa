-- Drop obsolete get_pipeline_progress_24h; create get_daily_health_report for Discord daily health report.
-- Source of truth for pipeline monitoring going forward.

drop function if exists public.get_pipeline_progress_24h();
...
comment on function public.get_daily_health_report() is 'Returns pipeline metrics for Discord daily health report: throughput (24h), backlogs, failures, clustering (24h + active). Use for monitoring.';
