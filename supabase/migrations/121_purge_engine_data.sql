-- Introduces public.purge_engine_data() to wipe pipeline-derived rows.
-- Table list: doxa-agents/ops/purge-engine-tables.yaml
-- Regenerate function body: npm run agents:refresh, then re-apply supabase/routines/purge_engine_data.sql
