-- Claim version pointer revert: non-destructive QA undo for claims lane.
...
COMMENT ON FUNCTION public.revert_story_pipeline_step(uuid, text, uuid) IS
  'Reverts one pipeline step. Claims QA undo uses version pointers and keeps artifacts/versions.';
