-- Add story_events_created and events_created to get_daily_health_report.
...
comment on function public.get_daily_health_report() is 'Pipeline metrics for Discord daily health; includes story_events and canonical events (24h).';
