-- Restore stories_approved, stories_dropped, stories_pending_24h, and scrape columns
-- so discord_daily_health can display KEEP/DROP and scraping KPIs correctly.
-- Migration 104 consolidated stories_reviewed and dropped these columns.
