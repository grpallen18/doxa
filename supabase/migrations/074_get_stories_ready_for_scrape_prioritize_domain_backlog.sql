-- Prioritize domains by backlog size: pick from the domain with the most eligible stories.
-- Keeps work spread across sources and avoids bottlenecks where one domain dominates the tail.
