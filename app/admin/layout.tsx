...
function adminShellClass(pathname: string): string | undefined {
  ...
  if (isNeoDetailRoute(pathname)) {
    return 'min-h-0 h-[calc(100svh-var(--header-height))] max-h-[calc(100svh-var(--header-height))] gap-0 overflow-hidden bg-surface-canvas px-0 sm:px-0 md:px-0 lg:px-0'
  }
