...
const healthMetrics = [
  ...
  { label: 'Scrape success', value: ADMIN_STATUS_PLACEHOLDER.scrapeSuccessRate, href: '/admin/health' },
  ...
  { label: 'Chunks extracted (24h)', value: ADMIN_STATUS_PLACEHOLDER.chunksExtracted24h, href: '/admin/health' },
  { label: 'Merges completed (24h)', value: ADMIN_STATUS_PLACEHOLDER.mergesCompleted24h, href: '/admin/health' },
  { label: 'Controversies', value: ADMIN_STATUS_PLACEHOLDER.controversiesActive, href: '/admin/positions' },
  { label: 'Viewpoints', value: ADMIN_STATUS_PLACEHOLDER.viewpointsActive, href: '/admin/positions' },
  { label: 'Events linked', value: ADMIN_STATUS_PLACEHOLDER.eventsLinked, href: '/admin/stories' },
  { label: 'Stuck processing', value: ADMIN_STATUS_PLACEHOLDER.stuckProcessing, href: '/admin/health' },
] as const
