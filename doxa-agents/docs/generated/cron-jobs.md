...
| extract-story-entities-every-2min | extract-story-entities | extract_story_entities | `*/2 * * * *` | inactive | [schedule.sql](doxa-agents/divisions/02-processing-engine/02-story-extraction/01-extract-story-entities/schedule.sql) |
| merge-story-entities-every-2min | merge-story-entities | merge_story_entities | `*/2 * * * *` | inactive | [schedule.sql](doxa-agents/divisions/02-processing-engine/03-story-synthesis/01-merge-story-entities/schedule.sql) |
