...
**Pause graph enqueue:** run [unschedule.sql](unschedule.sql) to stop the pg_cron that cleans + enqueues (e.g. AuraDB node caps). Re-enable with [schedule.sql](schedule.sql) after capacity is available.
